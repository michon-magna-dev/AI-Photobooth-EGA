...
public class OSC : MonoBehaviour
{
    ...
    public string outIP = "10.39.1.153";
    public int outPort = 7001;
    ...
    void Start()
    {
        inPort = ConfigManager.GetInstance().GetValue("UNITY_OSC_SIGNAL_RECEIVE_PORT");
        outIP = ConfigManager.GetInstance().GetStringValue("UNITY_OSC_OUT_IP_ADDRESS");
        outPort = ConfigManager.GetInstance().GetValue("UNITY_OSC_OUT_PORT");
